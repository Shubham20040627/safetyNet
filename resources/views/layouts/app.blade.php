...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100 text-gray-900">
        <div x-data="{ mobileMenuOpen: false }" class="min-h-screen flex overflow-x-hidden">
            ...
            <div x-show="mobileMenuOpen"
                 ...
                 class="fixed inset-y-0 left-0 w-64 bg-slate-950 text-white z-50 shadow-2xl md:hidden"
                 style="display: none;">
            ...
            <!-- Desktop Sidebar -->
            <div class="hidden md:block w-64 bg-slate-900 text-white flex-shrink-0 shadow-2xl border-r border-slate-800">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                <!-- Top Navbar -->
                <header class="bg-white shadow-sm border-b h-16 flex items-center justify-between px-4 md:px-8">
